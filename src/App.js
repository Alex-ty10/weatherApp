          ...
          <div className="flex flex-col items-center justify-center h-full">
            ...
            <form noValidate onSubmit={e => handleSubmit(e)} className="flex justify-center w-full">
              <input type="text" 
                ...
                className="focus:outline outline-1 outline-gray-300 focus:bg-slate-700 focus:bg-opacity-40 focus:placeholder-gray-50 relative rounded-xl py-2 px-3 w-4/5 bg-gray-300 bg-opacity-40 text-white placeholder-gray-200"
                value={searchTerm}
